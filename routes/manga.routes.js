...
mangaExpressRoute.route('/').get((req, res, next) => {
...
mangaExpressRoute.route('/manga/:id').get((req, res, next) => {
...
mangaExpressRoute.route('/delete-manga/:id').delete((req, res, next) => {
...
mangaExpressRoute.route('/update-manga/:id').put((req, res, next) => {
